...
export const garcom = new RedePetriHandler();
garcom.createPetriNet();
garcom.petriNet?.getLugarByLabel("garcomLivre")?.insereToken(5);

//-------------------- Recursos do sistema--------------------

export const atendenteCaixa1 = scheduler.createResource(
  new Resource("atendenteCaixa1", 1, () => scheduler.getTime())
);
export const atendenteCaixa2 = scheduler.createResource(
  new Resource("atendenteCaixa2", 1, () => scheduler.getTime())
);
